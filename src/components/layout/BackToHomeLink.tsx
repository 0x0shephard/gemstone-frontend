...
export function BackToHomeLink({ compact = false, className }: BackToHomeLinkProps) {
  return (
    <Link
      ...
      className={cn(
        'group inline-flex h-10 items-center justify-center gap-2 rounded-[4px] border border-line/[0.1] bg-line/[0.025] text-[12px] font-semibold text-ink-muted transition-colors hover:border-line/[0.2] hover:bg-line/[0.055] hover:text-ink',
