  ...
  return (
    <>
      ...
      <aside
        ...
        className="fixed inset-y-0 left-0 z-50 flex w-[min(300px,calc(100vw-20px))] flex-col border-r border-line/[0.09] bg-sidebar shadow-[24px_0_80px_rgba(0,0,0,.5)] animate-dcdrawer"
      >
        <div className="flex items-center justify-between px-6 pb-8 pt-6">
          ...
          <button
            ...
            className="grid h-9 w-9 place-items-center rounded-[4px] border border-line/[0.08] bg-line/[0.025] text-ink-muted transition-colors hover:border-atelier/30 hover:bg-atelier/[0.08] hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-atelier/70"
          >
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      cn(
                        ...
                        isActive
                          ? 'border-line/[0.09] bg-atelier/[0.09] font-semibold text-ink shadow-[inset_3px_0_0_var(--dc-accent)]'
                          : 'border-transparent font-medium text-ink-muted hover:border-line/[0.05] hover:bg-line/[0.025] hover:text-ink',
                      )
                    }
                  >
        ...
        <div className="border-t border-line/[0.07] p-4">
          <div className="rounded-[4px] border border-line/[0.07] bg-line/[0.025] p-3.5">
            ...
            {isApproved && (
              <div className="mt-2.5 border-t border-line/[0.06] pt-2.5 text-[10px] font-semibold uppercase tracking-[0.13em] text-emerald">
                Verified identity
              </div>
            )}
          </div>
