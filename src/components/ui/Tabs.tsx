...
export function Tabs<T extends string>({ tabs, value, onChange }: TabsProps<T>) {
  return (
    <div className="flex gap-1 overflow-x-auto rounded-[13px] border border-white/[0.07] bg-white/[0.02] p-1">
      {tabs.map((t) => {
        ...
        return (
          <button
            ...
            className={cn(
              'inline-flex items-center gap-2 whitespace-nowrap rounded-[9px] border px-[15px] py-[8px] text-[13px] transition-colors',
              active
